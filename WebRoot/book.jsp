			...
			<!-- 商品循环开始 -->
			 ...
			 BookDAO book = new	 BookDAO();
		 	 ...
		 	 if(booklist!=null && booklist.size()>0){
				...
				<div class="bookitem">
					<dl>
						<dt><a href="book_detail.jsp?book_no=<%=booksBean.getISBN()%>"><img src="./images/<%=booksBean.getPicture()%>.jpg" alt="无法加载图片资源"></a></dt>
						<dd><a href="book_detail.jsp?book_no=<%=booksBean.getISBN()%>"><%=booksBean.getBook_name() %></a></dd>
						<dd><a href="book_detail.jsp?book_no">剩余数量:<%=booksBean.getBook_rest_num()%></a></dd>
						<dd><a href="book_detail.jsp?book_no">图书室:<%=booksBean.getLibrary_name()%></a></dd>
					</dl>
				</div>
				<%
